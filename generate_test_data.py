...
zostoga_file_path = "/badc/cmip5/data/cmip5/output1/MOHC/HadGEM2-ES/rcp45/mon/ocean/Omon/r1i1p1/latest/zostoga"
...
for file in filelist:
    ...
    cmd = f"ncks  {lat_selector} {lon_selector} --variable {var_id} {path} {output_file}"
    print("running", cmd)
